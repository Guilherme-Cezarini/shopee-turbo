...
type Environment struct {
	...
	MongoDbAccessTokenCollection string        `env:"MONGODB_ACCESS_TOKEN_COLLECTION"`
	...
	MercadoLivreTokenUrl         string        `env:"MERCADO_LIVRE_TOKEN_URL"`
	SessionSecure                bool          `env:"SESSION_SECURE"`
